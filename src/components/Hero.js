...
const Hero = ({appType, tagLine, description, mainActionText, extraActionText}) => {
  return (
    <div id="product">
      <div style={{textShadow:'0px 1px 1px gray'}} className="flex flex-col items-center justify-start font-sans min-h-96 bg-gray-50 lg:pt-10 lg:pb-20 lg:bg-gray2 lg:bg-repeat lg:bg-left-bottom">
        {/* <div>
        ...
        <div className="relative z-50 flex flex-col items-center justify-between h-48 lg:space-x-8 pt-7 lg:pt-0 lg:flex-row lg:justify-between lg:w-90">
          <button
            className="pt-3 pb-3 pl-12 pr-12 text-2xl font-semibold text-center text-white transition-all bg-red rounded-full shadow-2xl lg:ml-5 hover:ring-white hover:ring-4 focus:outline-none ring-4 ring-red lg:ring-2 lg:font-medium "
          >
            {mainActionText}
          </button>
          <button
            className="pt-3 pb-3 text-2xl font-semibold text-center text-red transition-all rounded-full shadow-2xl lg:mr-5 hover:text-red hover:bg-gray-50 pl-11 pr-11 bg-gray-50 focus:outline-none ring-4 ring-red lg:font-medium lg:text-gray-50 lg:bg-opacity-0 lg:ring-2 lg:ring-white"
          >
            {extraActionText}
          </button>
        </div>
