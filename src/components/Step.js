    ...
    return (
        <div className={alternate?row : rowReverse}>
          <div className="lg:w-2/6 lg:-ml-20 lg:-mt-10 lg:flex lg:flex-col lg:justify-center lg:items-start">
            <p className="pb-5 text-xl font-semibold text-center text-red lg:pb-0 lg:-mb-3 lg:text-lg lg:font-bold lg:text-left">{title}</p>
            <p className="p-5 text-4xl font-semibold leading-relaxed text-center text-gray2 lg:pb-4 lg:text-3xl lg:pl-0 lg:font-bold lg:text-left">{heading}</p>
          ...
          <div className="ml-10 pl-8 sm:items-center lg:ml-0 lg:w-3/6" >
          {/* <div className="ml-10 lg:ml-0 lg:w-3/6"> */}
            <img className=" lg:mt-10 lg:mb-1" height="80%" width="80%" src={img} alt=""/>
